...
### Source file layout (as of Phase 4B)

- `main.py` — FastAPI app composition layer; public routes, redirect/media/auth/migration logic; imports and wires page_renderer and page_admin
