...
SafetyAlert, SafetyDailyState, SafetyEmergency) that safety_telegram's
message formatters read afterward, inside main.py's `_deliver_*` helpers.
...
_SCRIPT = textwrap.dedent(
    ...
    db.add_all([reminder_user, missed_user, sos_user])
    db.commit()
    ...
    reminders, missed, sos = main._collect_due_safety_notifications()
