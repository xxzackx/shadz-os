...
- **Phase 4L — Template Structure Stabilization** — not started. Next roadmap phase.
- Future Page Engine UX improvements generally (beyond 3E polish, 4K polish, 4Ka polish, the read-endpoint gap, and Phase 4L above) — not scoped or started
