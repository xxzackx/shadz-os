...
- **Bot Engine — remaining work:**
  ...
  - **Phase T1H (next, not started): Restore / cleanup polish for Bot Client lifecycle** — e.g. surfacing deleted-client history/audit trail if desired, bulk client management; deliberately deferred out of T1G to keep that change surgical
