...
- **Activation Engine v1 — locked roadmap. Phase A1 (`54e0801`/`745d304`, closed 2026-07-24, `activation_records` data foundation), Phase A2 (`9ec0458`+`e713480`, closed, deployed and production-tested — First-Scan Telegram Entry plus the admin provisioning correction), and Phase A3 (`acb8690`, closed, deployed and production-tested — Bot Client Creation and Access Code) are all complete and closed — see Completed milestones. Remaining phases (not started):**
  - **Phase A4U — URL Content Setup:** URL slug asks for destination URL; validate and confirm the URL
  - **Phase A4M — Media Content Setup:** media slug asks for media upload; validate and confirm the media
