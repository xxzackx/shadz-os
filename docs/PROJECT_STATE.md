...
- **Bot Engine — remaining work:**
  ...
  - **Phase T1I — closed (`57b2229`, deployed 2026-07-06):** Check Slug → Bot Client assign shortcut added to `static/admin.html`; no backend change. Deleted-client history/audit trail and bulk client management remain future backlog / out of scope, not yet scheduled.
