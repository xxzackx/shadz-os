...
- **Activation Engine v1 — remaining work (Phase A1, `54e0801`/`745d304`, closed 2026-07-24, delivered only the `activation_records` data foundation):**
  - Activation routing / pre-activation redirect behavior for the NFC chip URL (`https://shadz.io/{slug}`) — not started
  ...
  - Telegram bot activation flow — not started
