...
- **Bot Engine — remaining work:**
  ...
  - Deleted-client history/audit trail and bulk client management remain future backlog / out of scope, not yet scheduled (unchanged by T1J).
